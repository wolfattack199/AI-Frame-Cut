...
EDIT it fast — grade, animated titles (with optional channel avatar + Subscribe/Like
CTA), background music with ducking, trim, cut, concat, speed, resize, gif, voice/audio
effects, and quick previews — all over ffmpeg + Pillow + faster-whisper. Can also grab a
